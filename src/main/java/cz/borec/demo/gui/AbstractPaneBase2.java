...
public abstract class AbstractPaneBase2 extends BorderPane {
	...
	public void construct() {
		...
		//String image = getClass().getResource("light_texture1.jpg").toExternalForm();
		...
		//setBackground(new Background(new BackgroundFill(Color.web("#F5F4F4") /* e5e5e5 Color.LIGHTBLUE*/, new CornerRadii(5.0), Insets.EMPTY)));
...
*/
	...
	protected SubCategoryButton[] createHyperlinks(List<? extends BaseDTO<Long>> dtos) {
